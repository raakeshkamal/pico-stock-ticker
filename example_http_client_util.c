...
void http_client_result_print_fn(__unused void *arg, httpc_result_t httpc_result, u32_t rx_content_len, u32_t srv_res, err_t err) {
    HTTP_INFO("result %d len %u server_response %u err %d\n", httpc_result, rx_content_len, srv_res, err);
}
